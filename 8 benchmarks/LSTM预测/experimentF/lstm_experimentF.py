...
train_dataset = read_csv('trainingF.csv',header=0,index_col=None)
train_values = train_dataset.values

test_dataset = read_csv('testingF.csv', header=0, index_col=None)
...
df.to_csv("experimentF_LSTM_result.csv", index=False)
