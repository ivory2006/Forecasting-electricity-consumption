...
train_dataset = read_csv('trainingE.csv',header=0,index_col=None)
train_values = train_dataset.values

test_dataset = read_csv('testingE.csv', header=0, index_col=None)
...
df.to_csv("experimentE_LSTM_result.csv", index=False)
