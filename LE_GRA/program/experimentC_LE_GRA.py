...
def topn_optimal(n):
    ...
    for i in index:
        ...
        optimal = valid_start("valid6.csv", X)
        if optimal < max:
            Y = X
            max = optimal
...
if __name__ == "__main__":
    preprocessing("trainingC.csv", "train6.csv")
    preprocessing("testingC.csv", "test6.csv")
    train_start("train6.csv")
    test_start("test6.csv", 30)
