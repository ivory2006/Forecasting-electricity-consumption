...
def topn_optimal(n):
    ...
    for i in index:
        ...
        optimal = valid_start("valid5.csv", X)
        if optimal < max:
            Y = X
            max = optimal
...
if __name__ == "__main__":
    preprocessing("trainingD.csv", "train5.csv")    
    preprocessing("testingD.csv", "test5.csv")
    train_start("train5.csv")
    test_start("test5.csv", 20)
