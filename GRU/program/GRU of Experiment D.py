...
test_dataset = read_csv('testingD.csv', header=0, index_col=None)
...
# fit network
history = model.fit(train_X, train_y, epochs=10, batch_size=8, verbose=2, shuffle=False)
...
df.to_csv("experimentD_GRU_result.csv", index=False)
