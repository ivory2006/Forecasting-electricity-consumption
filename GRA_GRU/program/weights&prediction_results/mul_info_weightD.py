...
def mul_info_weightD(gru_valid_file, le_valid_file):
    ...
    df.to_csv("experimentD_mutual_information.csv", index=False)
...
gru_weight, le_weight = mul_info_weightD("experimentD_GRU_validation_result.csv", "experimentD_LE_validation_result.csv")
