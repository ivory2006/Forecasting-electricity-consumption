...
def mul_info_weightA(gru_valid_file, le_valid_file):
    ...
    #gru概率的对数
    gru_probability_log = log10(gru_frequency_probability)
    ...
    # le概率的对数
    le_probability_log = log10(le_frequency_probability)
    ...
    #gru与le准确率的商
    mul_accurary_division = le_accurary / gru_accurary
    ...
    mul_division_single_log = log10(mul_division_single)
    ...
    print(average(mutual_information),average(gru_self_entrocy),average(le_self_entrocy))
    ...
    df.to_csv("experimentA_mutual_information.csv", index=False)
...
gru_weight, le_weight = mul_info_weightA("experimentA_GRU_validation_result.csv", "experimentA_LE_validation_result.csv")
