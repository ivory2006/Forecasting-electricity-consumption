...
def mul_info_weightF(gru_valid_file, le_valid_file):
    ...
    df.to_csv("experimentF_mutual_information.csv", index=False)
...
gru_weight, le_weight = mul_info_weightF("experimentF_GRU_validation_result.csv", "experimentF_LE_validation_result.csv")
